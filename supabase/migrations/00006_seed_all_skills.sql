...
-- Ensure all 50 skills exist (no status column — that moved to user_skills in 00004)
...
-- Backfill user_skills for existing users who are missing rows for new skills
